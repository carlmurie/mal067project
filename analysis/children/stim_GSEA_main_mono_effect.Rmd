...
DO_VACCINE <- ifelse(time=="M3", TRUE, FALSE)
...
p_cut <- 0.01
min_gene_set <- 5
form_interact_vac <- "~plate + total_reads + age_weeks + pid + monocyte + vaccine"
form_interact_dis <- "~plate + total_reads + age_weeks + pid + monocyte + case"
...
####vaccine    
`r if(DO_VACCINE) {htmltools::knit_print.html("####vaccine")}` 
