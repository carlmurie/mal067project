---
title: "Integrate ICS CD8 Polyfunctional Scores (PFS) and RNASeq data"
subtitle: "HBS"
...
pfs <- readRDS(here("data/CD8_HBS_PFS.rds"))
stim <- "hbs"
```
...
prune_meta$targets <- prune_meta$targets[,c("col_id", "plate", "age_weeks", "sid", "vaccine",
